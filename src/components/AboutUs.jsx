...
const AboutUs = () => {
    ...
    const entrepreneurSolutions = [
        {
            icon: Landmark,
            title: "Enabling Access to Capital",
            ...
            <div className="w-full bg-[#fafafa] pt-16 sm:pt-20 lg:pt-32">
                    ...
                    <div className="max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-10 w-full flex flex-col items-center text-center">
                        ...
                        <div className="flex flex-col sm:flex-row w-full mb-10 sm:mb-16 lg:mb-20">
                            {entrepreneurSolutions.map((solution, idx) => (
                                <div key={idx} className={`flex-1 flex flex-col items-center text-center px-4 lg:px-8 py-8 md:py-0 ${idx !== 0 ? 'border-t md:border-t-0 md:border-l border-gray-100' : ''}`}>
                ...
                <div id='3' className="relative w-full min-h-screen flex flex-col justify-center items-center py-14 sm:py-20 lg:py-24 overflow-hidden">
                    ...
                    <div className="relative z-20 max-w-[1400px] mx-auto px-5 sm:px-8 lg:px-10 w-full flex flex-col items-center text-center">
                        ...
                        {/* Features Row */}
                        <div className="flex lg:flex-row flex-col space-y-10 mb-10 items-center lg:justify-between lg:items-center w-full lg:mb-15 border-r border-l border-white/40 bg-black/20">
                            <div className='flex flex-col w-60 lg:w-65  px-2 lg:px-5 py-5 lg:py-5 gap-5'>
                                <div>
                            ...
                            <div className=' md:border-white/40 lg:border-white/40  md:h-50 lg:h-50 md:border lg:border'>

                            </div>
                            {/* 2nd */}
                            <div className='flex flex-col w-60 lg:h-68 lg:w-65  py-5 lg:py-4 gap-5'>
                                ...
                                <div className='text-white text-sm poppins-sans font-light lg:px-5'>
                                    <p>Structured data and industry commentary to sharpen your investment approach.</p>
                                </div>
                            </div>
                            ...
                            <div className='md:border-white/40 lg:border-white/40  md:h-50 lg:h-50 md:border lg:border'></div>

                            <div className='flex flex-col w-60 lg:h-68 lg:w-65  px-2 lg:px-5 py-5 lg:mb-10 gap-5'>
                        ...
                        <div className="flex flex-col items-center text-center">
                            ...
                            <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-[32px] font-normal mb-6 sm:mb-10 text-white leading-tight max-w-3xl" style={{ fontFamily: 'PT Serif, serif' }}>
                ...
                <div id='4' className="w-full min-h-screen bg-white flex flex-col justify-center py-14 sm:py-20 lg:py-28">
                    <div className="max-w-[1200px] mx-auto px-5 sm:px-8 lg:px-10 w-full">
                        ...
                        <div className="flex flex-col items-center text-center mb-12 lg:mb-16">
                            ...
                            <p className="text-[#4a4a4a] text-[16px] lg:text-[16px] max-w-4xl leading-relaxed poppins-sans">
                        ...
                        <div className="flex flex-wrap w-full">
                            {(() => {
                                const expectations = [
                                    ...
                                    { num: '04', text: 'Portfolio reporting through a single and unified dashboard' },
                                ...
                                return expectations.map((item, idx) => (
                                    <div key={idx} className={`w-full md:w-1/2 lg:w-1/3 bg-white p-8 sm:p-10 lg:p-12 flex flex-col justify-start ${borders[idx]}`}>
                                        <span className="text-[#D4AF37] text-[42px] lg:text-[50px] leading-none mb-5 pt-serif">
                                            {item.num}
                                        </span>
                                        <p className="text-black/90 text-[15px] lg:text-[15px] leading-relaxed max-w-[270px] pt-serif">
                                            {item.text}
                                        </p>
                                    </div>
                                ));
                ...
                <div id='6' className="w-full bg-black flex flex-col items-center justify-center py-16 sm:py-24 lg:py-32">
                    <div className="max-w-[1400px] mx-auto px-10 sm:px-8 flex flex-col items-center text-center">
                        ...
                        <p className="text-white text-[15px] sm:text-[16px] lg:text-[17px] leading-relaxed mb-8 sm:mb-12 max-w-[1000px] poppins-sans">
